...
class AxisAPI
{
	...
	function sendLogin($nomor, $otp){
		$url="https://wdcloudssh.net/api/new/axis/otp/login";
	...
	function getBuyPackageV2($token, $pkgid){
		$url="https://wdcloudssh.net/api/new/axis/otp/package";
	...
	function getListPackageV2()
	{
		...
		CURLOPT_URL => 'https://wdcloudssh.net/api/new/axis/otp/list',
	...
	{
		$url="https://wdcloudssh.net/api/new/axis/otp/getbalance";
